...
public abstract class MiuiHomeHookRuntime extends MiuiHomeReturnHomeRuntime {
    ...
    protected void hookMiuiHomeGestureStubShow(Class<?> gestureStubClass)
        ...
        registerHook(method, "miui_home_gesture_stub_show", this::restoreMiuiHomeGestureStubShow);
    }
    ...
    protected void hookMiuiHomeGestureInputArbiter(Class<?> processorClass,
        ...
        method.setAccessible(true);
        registerHook(method, "miui_home_gesture_input_arbiter", this::arbitrateMiuiHomeAcceptedInput);
    }
    ...
    protected void hookMiuiHomeRecentsActualState(Class<?> recentsContainerClass)
        ...
        method.setAccessible(true);
        registerHook(method,
                "miui_home_recents_actual_state_v2",
                this::mirrorMiuiHomeRecentsActualState);
    }
    ...
    protected void hookMiuiHomeReturnHomeInitialize(ClassLoader classLoader)
        ...
        method.setAccessible(true);
        registerHook(method, "miui_home_return_home_initialize", this::registerMiuiHomeReturnHome);
    }
    ...
    protected void hookMiuiHomeReturnHomeLocalHandoff(ClassLoader classLoader)
        ...
        for (Method method : implementorClass.getDeclaredMethods()) {
            if ("getLastAnimParam".equals(method.getName())
                ...
                method.setAccessible(true);
                registerHook(method,
                "miui_home_return_home_local_handoff",
                this::provideMiuiHomeReturnHomeLocalHandoff);
    ...
    protected void hookMiuiHomeReturnHomeWallpaperCommands(
        ...
        if (hookSet) {
            ...
            registerHook(setTo,
                "miui_home_return_home_wallpaper_set",
                this::observeMiuiHomeReturnHomeWallpaperSet);
        }
        if (hookAnim) {
            ...
            registerHook(animTo,
                "miui_home_return_home_wallpaper_anim",
                this::observeMiuiHomeReturnHomeWallpaperAnim);
        }
    ...
    protected void hookMiuiHomeOpenBreakEnable(Class<?> breakControllerClass)
        ...
        method.setAccessible(true);
        registerHook(method, "miui_home_open_break_enable", this::captureMiuiHomeOpenBreakEnable);
    }
    ...
    protected void hookMiuiHomeOpenBreakAnimationStart(Class<?> listenerClass)
        ...
        method.setAccessible(true);
        registerHook(method,
                "miui_home_open_break_animation_start",
                this::mirrorMiuiHomeOpenBreakAnimationStart);
    }
    ...
    protected void hookMiuiHomeOpenBreakAnimationEnd(Class<?> listenerClass)
        ...
        method.setAccessible(true);
        registerHook(method,
                "miui_home_open_break_animation_end",
                this::mirrorMiuiHomeOpenBreakAnimationEnd);
    }
    ...
    protected void hookMiuiHomeLauncherOpenSnapshotTargets(
        ...
        method.setAccessible(true);
        registerHook(method,
                "miui_home_open_snapshot_targets",
    ...
    protected void hookMiuiHomeReusedCloseOpen(ClassLoader classLoader)
        ...
        method.setAccessible(true);
        registerHook(method, "miui_home_reused_close_open", this::restoreMiuiHomeReusedCloseOpen);
    }
    ...
    protected void hookMiuiHomeTransitionContinuity(
        ...
        if (hookElementTransition) {
            ...
            registerHook(injectRemoteTransition,
                "miui_home_return_home_element_transition",
                this::prepareMiuiHomeElementTransitionContinuity);
        }
        if (hookElementLeashRearm) {
            ...
            registerHook(clearOpenLeash,
                "miui_home_return_home_element_leash_rearm",
                this::rearmMiuiHomeElementLeashAfterNativeClear);
        }
        if (hookElementAnimType) {
            ...
            animTo.setAccessible(true);
            registerHook(animTo,
                "miui_home_return_home_element_anim_type",
                this::observeMiuiHomeElementAnimType);
        }
    ...
    protected void hookMiuiHomeUnifiedFinishEpoch(
        ...
        if (hookAnimToConfig) {
            ...
            registerHook(config,
                "miui_home_return_home_anim_to_config",
                this::observeMiuiHomeUnifiedAnimToConfigured);
        }
        if (hookFinishSource) {
            Method source = requireExactDeclaredMethod(
                    windowElementClass, "onFinishCompleted", "void");
            registerHook(source,
                "miui_home_return_home_finish_dispatch_source",
                this::captureMiuiHomeUnifiedFinishDispatch);
        }
        if (hookFinishApply) {
            ...
            registerHook(apply,
                "miui_home_return_home_finish_dispatch_apply",
                this::guardMiuiHomeUnifiedFinishDispatch);
        }
    ...
    protected void hookMiuiHomePermissionMerge(ClassLoader classLoader)
        ...
        registerHook(handlerMethod,
                "miui_home_permission_activity_merge",
                this::preserveMiuiHomeOpenAcrossPermissionMerge);
    }
    ...
    protected void hookMiuiHomeNativeGeometryUpdate(ClassLoader classLoader)
        ...
        registerHook(method, "miui_home_trace_on_anim_update", this::captureMiuiHomeNativeGeometry);
    }
    ...
    protected void hookMiuiHomeNativeGeometryApply(ClassLoader classLoader)
        ...
        registerHook(method,
                "miui_home_trace_apply_surface_params",
                this::applyMiuiHomeNativeSurfaceParams);
    }
    ...
    protected void hookMiuiHomeTransitionSetupLeash(
        ...
        registerHook(setupLeash,
                "miui_home_trace_transition_setup_leash",
                this::armMiuiHomeTransitionStartGeometry);
        moduleLog(Log.INFO, TAG,
    ...
    protected void hookMiuiHomeStartTransactionApply(
        ...
        try {
            Method method = SurfaceControl.Transaction.class.getDeclaredMethod(
                    "apply", boolean.class);
            method.setAccessible(true);
            registerHook(method, hookPrefix + "apply_boolean", this::applyMiuiHomeStartGeometry);
            moduleLog(Log.INFO, TAG,
    ...
    protected void hookMiuiHomeReturnHomeDirectCancel(ClassLoader classLoader)
        ...
        registerHook(cancelDirect,
                "miui_home_return_home_cancel_direct",
                this::wrapMiuiHomeReturnHomeDirectCancel);
        moduleLog(Log.INFO, TAG,
    ...
    protected void hookMiuiHomeReturnHomeSameIconParallel(ClassLoader classLoader)
        ...
        registerHook(cancelAnim,
                "miui_home_return_home_same_icon_parallel",
                this::routeMiuiHomeReturnHomeSameIconParallel);
        moduleLog(Log.INFO, TAG,
    ...
    protected void hookMiuiHomeReturnHomeFreshOpen(ClassLoader classLoader)
        ...
        registerHook(isOldElementReuseful,
                "miui_home_return_home_fresh_open",
                this::forceMiuiHomeReturnHomeFreshOpen);
        moduleLog(Log.INFO, TAG,
    ...
    protected void hookMiuiHomeDrawerState(ClassLoader classLoader)
        ...
        method.setAccessible(true);
        registerHook(method, "miui_home_drawer_state", this::mirrorMiuiHomeDrawerState);
    }
    ...
    protected void hookMiuiHomeFreeformBackTouchability(ClassLoader classLoader) {
        try {
            ...
            method.setAccessible(true);
            registerHook(method, "miui_home_freeform_back_touchability",
                    this::restoreMiuiHomeFreeformBackTouchability);
        } catch (Throwable throwable) {
    ...
    protected void hookMiuiHomeEditingState(ClassLoader classLoader) {
        try {
            ...
            method.setAccessible(true);
            registerHook(method, "miui_home_editing_state", this::mirrorMiuiHomeEditingState);
        } catch (Throwable throwable) {
        ...
        BroadcastReceiver receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context receiverContext, Intent intent) {
                ...
                if (newGeneration) {
                    ...
                    // HyperTweak: a new generation means SystemUI restarted and has forgotten
                    // that this launcher arbitrates. Announce again so it stops using its
                    // direct-pilfer fallback before the next gesture, instead of waiting for
                    // the lazy query on the first gesture-stub interaction.
                    try {
                        sendAuthenticatedMiuiHomeState(receiverContext,
                                new Intent(MODULE_MIUI_HOME_INPUT_ARBITER_QUERY));
                        moduleLog(Log.INFO, TAG, "Re-announced MiuiHome arbiter to restarted SystemUI"
                                + ", generation=" + generation);
                    } catch (Throwable throwable) {
                        moduleLog(Log.WARN, TAG, "Failed to re-announce MiuiHome arbiter", throwable);
                    }
